...
async function main() {
  ...
  // Categories
  const catData = [
    { id: 'c1', slug: 'crochet-bouquets', name: 'Crochet Flower Bouquets', tagline: 'Everlasting Knitted Blooms', description: 'Premium hand-knit flower bouquets crafted with luxury cotton threads. Perfect gifts that never wither.', image: 'https://images.unsplash.com/photo-1556228720-195a672e8a03?w=800' },
    { id: 'c2', slug: 'crochet-accessories', name: 'Chic Crochet Accessories', tagline: 'Hand-knitted Daily Essentials', description: 'Elegant hand-crocheted bags, bookmarks, and lifestyle accessories designed with precision.', image: 'https://images.unsplash.com/photo-1584917865442-de89df76afd3?w=800' },
    { id: 'c3', slug: 'crochet-decor', name: 'Cozy Crochet Decor', tagline: 'Soft Artisan Touches', description: 'Coasters, table mats, and warm home accents knitted by hand to elevate your space.', image: 'https://images.unsplash.com/photo-1544816155-12df9643f363?w=800' },
  ];
  ...
  // Products
  const products = [
    { id: 'p1', slug: 'royal-crochet-rose-bouquet', name: 'Royal Crochet Rose Bouquet', categoryId: 'c1', category: 'Crochet Flower Bouquets', categorySlug: 'crochet-bouquets', priceFrom: 450, leadTimeDays: '3–5 days', shortDescription: 'Luxurious bouquet of 7 hand-knitted red and pink roses.', description: 'Beautifully crafted using organic cotton yarns. Includes a elegant wrapping paper and customizable message card.', images: ['https://images.unsplash.com/photo-1561181286-d3fee7d55364?w=800', 'https://images.unsplash.com/photo-1591886960571-74d43a9d4166?w=800'], options: [{ id: 'opt-size', name: 'Bouquet Size', required: true, values: [{ id: 'v-m', name: 'Medium (7 Roses)', label: 'Medium (7 Roses)', priceDelta: 0 }, { id: 'v-l', name: 'Large (12 Roses)', label: 'Large (12 Roses)', priceDelta: 250 }] }], featured: true, badge: 'Best Seller', active: true },
    { id: 'p2', slug: 'eternal-tulip-pot', name: 'Eternal Crochet Tulip Pot', categoryId: 'c1', category: 'Crochet Flower Bouquets', categorySlug: 'crochet-bouquets', priceFrom: 180, leadTimeDays: '2–3 days', shortDescription: 'Cute desk-sized crochet tulip pot in pastel colors.', description: 'Brighten up your study desk or office with this charming everlasting tulip pot. Knitted with soft, premium acrylic and cotton blend.', images: ['https://images.unsplash.com/photo-1525310072745-f49212b5ac6d?w=800'], options: [{ id: 'opt-color', name: 'Flower Color', required: true, values: [{ id: 'v-pink', name: 'Pastel Pink', label: 'Pastel Pink', priceDelta: 0 }, { id: 'v-yellow', name: 'Sunny Yellow', label: 'Sunny Yellow', priceDelta: 0 }, { id: 'v-purple', name: 'Lavender Purple', label: 'Lavender Purple', priceDelta: 0 }] }], featured: true, badge: 'Popular', active: true },
    { id: 'p3', slug: 'boho-crochet-tote-bag', name: 'Boho Chic Crochet Tote Bag', categoryId: 'c2', category: 'Chic Crochet Accessories', categorySlug: 'crochet-accessories', priceFrom: 380, leadTimeDays: '5–7 days', shortDescription: 'Sturdy, hand-knitted boho style shoulder bag.', description: 'A spacious and fashionable tote bag knitted with thick cotton cords, featuring premium interior lining and comfortable handles.', images: ['https://images.unsplash.com/photo-1584917865442-de89df76afd3?w=800'], options: [], featured: true, badge: 'New Arrival', active: true },
    { id: 'p4', slug: 'daisy-chain-bookmark', name: 'Daisy Chain Crochet Bookmark', categoryId: 'c2', category: 'Chic Crochet Accessories', categorySlug: 'crochet-accessories', priceFrom: 45, leadTimeDays: '1–2 days', shortDescription: 'Delicate floral bookmark hand-knitted for book lovers.', description: 'Keep your place with this elegant chain of daisies. Made with extra-fine threads for a flat, beautiful design.', images: ['https://images.unsplash.com/photo-1544816155-12df9643f363?w=800'], options: [], featured: false, badge: 'Cozy Gift', active: true },
    { id: 'p5', slug: 'artisan-blossom-coasters', name: 'Artisan Blossom Crochet Coasters', categoryId: 'c3', category: 'Cozy Crochet Decor', categorySlug: 'crochet-decor', priceFrom: 90, leadTimeDays: '2 days', shortDescription: 'Set of 4 flower-shaped cup coasters in natural shades.', description: 'Add a warm, cottagecore aesthetic to your coffee table. Heat-resistant and machine-washable cotton.', images: ['https://images.unsplash.com/photo-1544816155-12df9643f363?w=800'], options: [], featured: false, badge: 'Home Favorite', active: true }
  ];
